...
export default {
  ...
  computed: {
    reports() {
      return this.$store.state.doctorReport.doctorReports;
    },
    queriedItems() {
      return this.$store.state.doctorReport.doctorReportTotal || 0;
    },
    pages() {
      return this.$store.state.doctorReport.doctorReportPages;
    },
    perPage() {
  ...
  methods: {
    ...
    onPageChange(page) {
      ...
      this.fetchDoctorReports({ itemsPerPage: this.itemsPerPage });
    },

    fetchDoctorReports({ itemsPerPage = 10 }) {
      this.$store.dispatch('doctorReport/fetchDoctorReports', {
