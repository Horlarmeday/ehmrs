  ...
  <div class="card card-custom gutter-b">
    <div class="card-header py-5">
      <h3 class="card-title align-items-start flex-column">
        ...
        <span class="text-muted mt-2 font-weight-normal font-size-sm"
          >View financial records for currently admitted patients</span
        >
      </h3>
    </div>
    <div class="card-body">
            ...
            <tr v-for="admission in admissions" :key="admission.id">
              ...
              <td class="text-right pr-0">
                <b-button
                  ...
                  size="sm"
                  class="btn-icon"
                  @click="viewFinancialRecords(admission)"
                  v-b-tooltip.hover
...
export default {
  name: 'AccountingAdmittedPatients',
  ...
  methods: {
    ...
    viewFinancialRecords(admission) {
      this.$router.push({
        path: '/accounting/patient-financial-lookup',
        query: { patientId: admission.patient_id },
      });
    },
