...
export default {
  data: () => ({
    routes: [
      {
        name: 'Ante-Natal Program',
        link: '/program/ante-natal',
        desc: 'Enrol patients into the ante-natal program',
      },
      {
        name: 'Immunization Program',
        link: '/program/immunization',
        desc: 'Enrol patients into the immunization program',
      },
      {
        name: 'HIV Program',
        link: '/program/hiv',
        desc: 'Enrol patients into HIV program',
      },
      {
        name: 'Tuberculosis Program',
        link: '/program/tuberculosis',
        desc: 'Enrol patients into Tuberculosis program',
      },
    ],
  }),
  methods: {
