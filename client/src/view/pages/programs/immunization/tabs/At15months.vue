<template>
  <div class="card card-custom card-stretch gutter-b card-shadowless">
    <div class="card-body">
      <immunization-accordion heading="At 15 Months" :medication="at15months" />
      <div class="mt-lg-5">
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-8">
            <v-select
              v-model="medications_at_15_months"
        ...
        <div>
          <button
            ...
            @click="updateAt15Months"
            :disabled="isDisabled || !isEmpty(at15months)"
            ref="kt_at15months_submit"
          >
            Submit
          </button>
        </div>
        ...
        if (result) {
          const obj = {
            data: {
              at_fifteen_months: {
                weight: this.weight,
                medications: this.medications_at_15_months,
                createdAt: new Date(),
                staff: {
          ...
          const submitButton = this.$refs['kt_at15months_submit'];
