<template>
  <div class="card card-custom card-stretch gutter-b card-shadowless">
    <div class="card-body">
      <immunization-accordion heading="At 6 Weeks" :medication="at6weeks" />
      <div class="mt-lg-5">
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-8">
            <v-select
              v-model="medications_at_6_weeks"
        ...
        <div>
          <button
            ...
            @click="updateAt6Weeks"
            :disabled="isDisabled || !isEmpty(at6weeks)"
            ref="kt_at6weeks_submit"
          >
            Submit
          </button>
        </div>
        ...
        if (result) {
          const obj = {
            data: {
              at_six_weeks: {
                weight: this.weight,
                medications: this.medications_at_6_weeks,
                createdAt: new Date(),
                staff: {
          ...
          const submitButton = this.$refs['kt_at6weeks_submit'];
