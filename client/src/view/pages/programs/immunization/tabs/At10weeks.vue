<template>
  <div class="card card-custom card-stretch gutter-b card-shadowless">
    <div class="card-body">
      <immunization-accordion heading="At 10 Weeks" :medication="at10weeks" />
      <div class="mt-lg-5">
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-8">
            <v-select
              v-model="medications_at_10_weeks"
        ...
        <div>
          <button
            ...
            @click="updateAt10Weeks"
            :disabled="isDisabled || !isEmpty(at10weeks)"
            ref="kt_at10weeks_submit"
          >
            Submit
          </button>
        </div>
        ...
        if (result) {
          const obj = {
            data: {
              at_ten_weeks: {
                weight: this.weight,
                medications: this.medications_at_10_weeks,
                createdAt: new Date(),
                staff: {
          ...
          const submitButton = this.$refs['kt_at10weeks_submit'];
