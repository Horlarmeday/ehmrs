<template>
  <div class="card card-custom card-stretch gutter-b card-shadowless">
    <div class="card-body">
      <immunization-accordion heading="At 14 Weeks" :medication="at14weeks" />
      <div class="mt-lg-5">
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-8">
            <v-select
              v-model="medications_at_14_weeks"
        ...
        <div>
          <button
            ...
            @click="updateAt14Weeks"
            :disabled="isDisabled || !isEmpty(at14weeks)"
            ref="kt_at14weeks_submit"
          >
            Submit
          </button>
        </div>
        ...
        if (result) {
          const obj = {
            data: {
              at_fourteen_weeks: {
                weight: this.weight,
                medications: this.medications_at_14_weeks,
                createdAt: new Date(),
                staff: {
          ...
          const submitButton = this.$refs['kt_at14weeks_submit'];
