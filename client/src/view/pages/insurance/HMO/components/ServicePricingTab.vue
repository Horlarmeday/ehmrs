      ...
      <div class="card-header border-0 py-4">
        ...
        <div class="card-toolbar">
          <button
            ...
            @click="$emit('open-create-modal', 'services')"
          >
            <i class="fas fa-plus mr-2"></i>Add Service Pricing
          </button>
        </div>
      </div>
            ...
            <thead>
              <tr class="text-left">
                <th class="pl-4" style="min-width: 200px">
                  <span class="text-dark-75 font-weight-bolder">Service Name</span>
                </th>
              ...
              <tr v-if="pricing.length === 0">
                <td colspan="9" class="text-center py-8">
                  <div class="text-muted">
                    ...
                    <p class="font-size-lg">No service pricing found</p>
                    <p class="font-size-sm">Click "Add Service Pricing" to get started</p>
                  </div>
                </td>
              </tr>
                ...
                <td class="pl-4">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <span class="text-muted d-block font-size-sm">{{ item.service.code }}</span>
                    </div>
                  </div>
                </td>
                <td>
