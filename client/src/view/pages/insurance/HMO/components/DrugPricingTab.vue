    ...
    <div class="card card-custom gutter-b">
      <div class="card-header border-0 py-4">
        ...
        <div class="card-toolbar">
          <button class="btn btn-success btn-sm font-weight-bold" @click="handleAddClick">
            <i class="fas fa-plus mr-2"></i>Add Drug Pricing
          </button>
        </div>
      </div>
            ...
            <thead>
              <tr class="text-left">
                <th class="pl-4" style="min-width: 200px">
                  <span class="text-dark-75 font-weight-bolder">Drug Name</span>
                </th>
              ...
              <tr v-if="pricing.length === 0">
                <td colspan="9" class="text-center py-8">
                  <div class="text-muted">
                    ...
                    <p class="font-size-lg">No drug pricing found</p>
                    <p class="font-size-sm">Click "Add Drug Pricing" to get started</p>
                  </div>
                </td>
              </tr>
                ...
                <td class="pl-4">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <span class="text-muted d-block font-size-sm">{{ item?.drug?.code }}</span>
                    </div>
                  </div>
                </td>
                <td>
...
export default {
  ...
  mounted() {
    console.log('🔘 DrugPricingTab component mounted successfully');
    console.log('🔘 Props received:', { pricing: this.pricing, hmoProviders: this.hmoProviders });
  },
  methods: {
    ...
    handleAddClick() {
      this.$emit('open-create-modal', 'drugs');
    },
  },
};
</script>
