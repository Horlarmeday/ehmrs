<template>
  <div class="investigation-pricing-tab">
      ...
      <div class="card-header border-0 py-4">
        ...
        <div class="card-toolbar">
          <button
            ...
            @click="$emit('open-create-modal', 'investigations')"
          >
            <i class="fas fa-plus mr-2"></i>Add Investigation Pricing
          </button>
        </div>
      </div>
            ...
            <thead>
              <tr class="text-left">
                <th class="pl-4" style="min-width: 200px">
                  <span class="text-dark-75 font-weight-bolder">Investigation Name</span>
                </th>
              ...
              <tr v-if="pricing.length === 0">
                <td colspan="9" class="text-center py-8">
                  <div class="text-muted">
                    ...
                    <p class="font-size-lg">No investigation pricing found</p>
                    <p class="font-size-sm">Click "Add Investigation Pricing" to get started</p>
                  </div>
                </td>
              </tr>
