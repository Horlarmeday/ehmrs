        ...
        <div class="card-header border-0 pt-5">
          <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-muted mt-3 font-weight-bold font-size-sm"
              >Monitor inventory levels and reorder points</span
            >
          </h3>
          ...
          <div class="card card-custom">
            <div class="card-header border-0 pt-5">
              <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-3 font-weight-bold font-size-sm"
                  >Inventory levels over time</span
                >
              </h3>
            </div>
            <div class="card-body">
          ...
          <div class="card card-custom">
            <div class="card-header border-0 pt-5">
              <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-3 font-weight-bold font-size-sm"
                  >Stock levels by medication category</span
                >
              </h3>
            </div>
            <div class="card-body">
      ...
      <div class="card card-custom">
        <div class="card-header border-0 pt-5">
          <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-muted mt-3 font-weight-bold font-size-sm"
              >Complete inventory tracking</span
            >
          </h3>
          <div class="card-toolbar">
...
export default {
  ...
  computed: {
    ...
    summary() {
      return (
        this.stockLevelReports?.summary || {
          outOfStock: 0,
          lowStock: 0,
          reorderPoint: 0,
          adequateStock: 0,
