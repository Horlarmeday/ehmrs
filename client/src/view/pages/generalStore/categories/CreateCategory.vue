  ...
  <div class="create-category-form">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <small class="form-text text-muted">
                    Leave empty to create a root category, or select a parent to create a
                    subcategory
                  </small>
                </div>
          ...
          <div class="card card-custom">
            ...
            <div class="card-body">
              <div class="quick-tips">
                ...
                <div class="tip-item mb-2">
                  <i class="flaticon2-check text-success mr-2"></i>
                  <small>Create logical hierarchies with parent categories</small>
                </div>
                <div class="tip-item mb-2">
                  <i class="flaticon2-check text-success mr-2"></i>
                  <small>Use consistent naming conventions</small>
                </div>
                <div class="tip-item">
                  <i class="flaticon2-check text-success mr-2"></i>
                  <small>Add descriptions for better understanding</small>
                </div>
              </div>
            </div>
          </div>
    ...
    <div v-if="loading" class="loading-overlay">
      <div class="spinner-border text-success" role="status">
        <span class="sr-only">Creating category...</span>
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    async loadParentCategories() {
      try {
        ...
        this.parentCategories = this.$store.state.generalStore.categories;
      } catch (error) {
    ...
    async handleSubmit() {
      ...
      try {
        ...
        await this.$store.dispatch('generalStore/createCategory', categoryData);
