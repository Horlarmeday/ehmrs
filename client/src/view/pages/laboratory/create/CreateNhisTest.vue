<template>
  <b-modal v-model="activePrompt" hide-footer title="NHIS Test">
    <div class="mb-15">
      ...
      <div class="form-group row">
        <label class="col-lg-3 col-form-label">NHIS Test Code</label>
        <div class="col-lg-8">
          <input
            v-validate="'required'"
            data-vv-validate-on="blur"
      ...
      <div class="form-group row">
        <label class="col-lg-3 col-form-label">Test Type</label>
        <div class="col-lg-8">
          <select
            class="form-control form-control-sm"
            v-model="type"
