      ...
      items: [
        {
          ...
          link: '/laboratory/reports/aggregate',
          desc: 'Generate aggregated tests reports',
        },
        {
          name: 'Non Conformity Reports',
          link: '/laboratory/reports/non-conformity',
          desc: 'Generate non-conformity tests reports',
        },
      ],
    };
  },
