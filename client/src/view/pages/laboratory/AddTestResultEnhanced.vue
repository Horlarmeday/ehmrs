<template>
  <div>
    <div v-if="sample" class="card card-custom gutter-b">
      <page-title title="Add Test Result (Enhanced)" />
    ...
    <test-skeleton v-else title="Add Test Result (Enhanced)" />
  </div>
</template>
...
import EnhancedResultSection from './resultsUpdate/EnhancedResultSection.vue';
