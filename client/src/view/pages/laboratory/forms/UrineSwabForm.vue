  ...
  <div class="form-container border border-gray-500">
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row">T. Vaginalis</th>
          <td>
            <input v-model="vaginalis_cells" type="text" class="form-control form-control-sm" />
          </td>
        </tr>
        <tr>
          <th scope="row">RBC</th>
        ...
        <tr>
          ...
          <td>
            <input v-model="cast" type="text" class="form-control form-control-sm" />
          </td>
        </tr>
        <tr>
          <th scope="row">Crystals</th>
          <td>
            <input v-model="crystals" type="text" class="form-control form-control-sm" />
          </td>
        </tr>
        <tr>
          <th scope="row">Parasites</th>
          <td>
            <input v-model="parasites" type="text" class="form-control form-control-sm" />
          </td>
        </tr>
        <tr>
          <th scope="row">Others</th>
          <td>
            <input v-model="others" type="text" class="form-control form-control-sm" />
          </td>
        </tr>
        <tr>
