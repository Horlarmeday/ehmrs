<template>
  <div>
    <h3 class="card-title align-items-start">
      <span class="card-label font-weight-bolder text-dark">Verified Tests</span>
    </h3>
    ...
    <div class="card">
      <div class="card-body">
        <test-approvals-table :period="period" />
      </div>
    </div>
  </div>
</template>
<script>
import TestApprovalsTable from '@/view/pages/laboratory/verifiedResults/VerifiedResultsTable.vue';

export default {
  components: { TestApprovalsTable },
  data: () => ({
    tabIndex: 0,
    period: 'Today',
    tabs: [
