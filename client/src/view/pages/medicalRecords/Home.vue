  ...
  data() {
    return {
      items: [
        {
          name: 'Record Reports',
          desc: 'Click here to view all medical record reports',
          link: '/medical-records/reports',
        },
        {
          name: 'Report Saved',
          link: '/medical-records/reports/saved',
          desc: 'Click here to view all saved reports',
        },
      ],
    };
  },
