export const INJECTION_SYRINGES_NOT_FOUND =
  'Injection was successfully prescribed but syringes was not added';

export const ERROR_UPDATING_DRUG = 'An error occurred while updating medications';
