...
export const ITEM_EXISTS_RETAINERSHIP = 'Item already exists in the store for Retainership';
export const ITEM_EXISTS_PLASCHEMA = 'Item already exists in the store for Plaschema';
