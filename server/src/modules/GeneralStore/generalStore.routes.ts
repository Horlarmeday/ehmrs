...
router.post(
  '/categories',
  GeneralStoreController.createCategory
);
router.put(
  '/categories/:id',
  GeneralStoreController.updateCategory
);
...
router.post(
  '/subcategories',
  GeneralStoreController.createSubcategory
);
router.put(
  '/subcategories/:id',
  GeneralStoreController.updateSubcategory
);
...
router.post(
  '/items',
  GeneralStoreController.createItem
);
router.put(
  '/items/:id',
  GeneralStoreController.updateItem
);
router.delete(
  '/items/:id',
  GeneralStoreController.deleteItem
);
...
router.post(
  '/movements',
  GeneralStoreController.createMovement
);
...
router.post(
  '/requests',
  GeneralStoreController.createRequest
);
router.put(
  '/requests/:id/approve',
  GeneralStoreController.approveRequest
);
router.put(
  '/requests/:id/reject',
  GeneralStoreController.rejectRequest
);
router.put(
  '/requests/:id/fulfill',
  GeneralStoreController.fulfillRequest
);
...
router.get(
  '/reports/stock',
  GeneralStoreController.getStockReport
);
router.get(
  '/reports/movements',
  GeneralStoreController.getMovementReport
);
router.get(
  '/reports/usage',
  GeneralStoreController.getUsageReport
);
router.get(
  '/reports/costs',
  GeneralStoreController.getCostReport
);
router.get(
  '/reports/low-stock',
  GeneralStoreController.getLowStockReport
);
router.get(
  '/reports/expiring',
  GeneralStoreController.getExpiringReport
);

// Audit Logs
router.get(
  '/audit-logs',
  GeneralStoreController.getAuditLogs
);
