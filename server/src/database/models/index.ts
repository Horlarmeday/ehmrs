...
export { DoctorReport } from './doctorReport';
...
export { InvestigationResultImage } from './investigationResultImage';
export { LaboratoryStore } from './laboratoryStore';
export { Laboratory } from './laboratory';
export { Measurement } from './measurement';
export { MeasurementDosageForm } from './measurementDosageForm';
