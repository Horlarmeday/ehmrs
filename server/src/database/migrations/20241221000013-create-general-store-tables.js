    ...
    try {
      ...
      await queryInterface.createTable(
        'General_Store_Request_Items',
        {
          ...
          notes: { type: Sequelize.TEXT, allowNull: true },
          status: {
            type: Sequelize.ENUM('PENDING', 'APPROVED', 'ISSUED', 'PARTIALLY_ISSUED'),
            allowNull: false,
            defaultValue: 'PENDING',
          },
          createdAt: { type: Sequelize.DATE, allowNull: false },
      ...
      await queryInterface.addIndex('General_Store_Items', ['item_code'], {
        unique: true,
        transaction,
      });
      ...
      await queryInterface.addIndex('General_Store_Subcategories', ['category_id'], {
        transaction,
      });
      ...
      await queryInterface.addIndex('General_Store_Movements', ['reference_type', 'reference_id'], {
        transaction,
      });

      // General_Store_Requests indexes
      await queryInterface.addIndex('General_Store_Requests', ['request_number'], {
        unique: true,
        transaction,
      });
      await queryInterface.addIndex('General_Store_Requests', ['requesting_department'], {
        transaction,
      });
