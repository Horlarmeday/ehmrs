...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await queryInterface.createTable('Procurement_Order_History', {
        id: {
      ...
      await queryInterface.addIndex('Procurement_Order_History', ['procurement_order_id', 'action', 'createdAt'], { 
