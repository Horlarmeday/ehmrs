...
export default class PDFDocumentWithTable extends PDFDocument {
  constructor(options: PDFKit.PDFDocumentOptions) {
    super(options);
  }

  table(table, arg0, arg1 = null, arg2 = null) {
    ...
    const usableWidth =
      options.width || this.page.width - this.page.margins.left - this.page.margins.right;
